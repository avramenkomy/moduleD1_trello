...
- Во время запусков программа будет постоянно запрашивать ID доски, api_key и token. Что бы не вводить эти параметры
  при каждом запуске, можно их сохранить в файле trello.py в переменные board_id и auth_params вместо input'ов
